...
const  Footer = () => {
    return (
    <>
        <Box border="1" fontWeight="700" bgColor="#518eaa" color="#fff" align="center">
            ...
            <Box p="8" bgColor="#61a3c2" color="#fff" align="center"  >
            ...
            <Box p="3" bgColor="#f70" color="white" align="center"  >
