...
const Hero = () => {
    return (
        ...
        <Box p={["4","5","6","7","8"]}  w={["100%","100%","100%","100%","75%"]} m="auto">
            <Heading color="#f70" as="h1" mb="24px">
            BendBroadband: high-speed Internet, TV packages, and phone services
            </Heading>
        ...
        <AspectRatio w={["100%","100%","100%","100%","100%"]} mb={["10px","20px","30px","30px","50px"]} ratio={[3, 3, 3, 3, 6/4]} >
            <Image objectPosition={["0 -90px","0 -70px","0 -100px","0 -120px", "0px"]} borderRadius={{xl: "0 0 0 70px"}} src="/hero-bendbroadband-image.jpg" alt="Hero Image BendBroadband" />
        </AspectRatio>
        </Flex>
        </Stack>
        </>
